        ...
        BrowseCourses: $defineScreen(BrowseCourses, [
            {
                ...
                createQuery: function () {
                    return this.dataWorkspace.ApplicationData.Courses.orderBy("CourseReference").thenBy("CourseVersion").expand("CourseStatus");
                }
            }
        ], [
        ]),
        ...
        BrowseEmployees: $defineScreen(BrowseEmployees, [
            {
                ...
                createQuery: function () {
                    return this.dataWorkspace.ApplicationData.Employees.orderBy("LastName").thenBy("FirstName").expand("EmployeeGroup");
                }
            }
        ], [
        ]),
        ...
        BrowseEmployeeTrainingRecords: $defineScreen(BrowseEmployeeTrainingRecords, [
            {
                name: "EmployeeTrainingRecords", kind: "collection", elementType: lightSwitchApplication.EmployeeTrainingRecord,
                createQuery: function () {
                    return this.dataWorkspace.ApplicationData.EmployeeTrainingRecords.expand("Course").expand("Employee");
                }
            }
        ], [
        ]),
        ...
        BrowseMyCourses: $defineScreen(BrowseMyCourses, [
            {
                ...
                createQuery: function () {
                    return this.dataWorkspace.ApplicationData.MyCourses().expand("CourseStatus");
                }
            }
        ], [
        ]),
        ...
        BrowseMyTrainingRecords: $defineScreen(BrowseMyTrainingRecords, [
            {
                ...
                createQuery: function () {
                    return this.dataWorkspace.ApplicationData.MyTrainingRecords().expand("Course");
                }
            }
        ], [
        ]),
        ...
        BrowseTrainingSessions: $defineScreen(BrowseTrainingSessions, [
            {
                name: "TrainingSessions", kind: "collection", elementType: lightSwitchApplication.TrainingSession,
                createQuery: function () {
                    return this.dataWorkspace.ApplicationData.TrainingSessions.expand("Course").expand("Employee");
                }
            }
        ], [
        ]),
